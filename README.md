...
### __Theano__ version is avaliable [here](https://github.com/fadymedhat/MCLNN-theano)
...
#### _NOTE:_ the below results are based on the Theano implementation of the MCLNN provided [here](https://github.com/fadymedhat/MCLNN-theano)
